...
import { useGetPaymentRequireInfo } from 'hooks/query/systemQuery';
import { useRRoundPay } from '@ui/hooks';
import { RefundInfoInquiryRespCommon } from 'type/api/claim';
    ...
    <>
      ...
      <S.OhDetailSecWrap>
        ...
        <S.AddPayInfoContainer>
          <S.PayInfoBox id={'claim-payment-container'} />
          <S.DescSumm>
            <li>
