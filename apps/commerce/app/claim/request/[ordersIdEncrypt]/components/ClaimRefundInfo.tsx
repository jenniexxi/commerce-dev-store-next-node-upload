...
import { CancelRefundInfoInquiryResp } from 'type/api/claim';
import * as S from './ClaimFeatures.style';
import { paymentMethodCode, PaymentMethodCode } from 'type/orders';
