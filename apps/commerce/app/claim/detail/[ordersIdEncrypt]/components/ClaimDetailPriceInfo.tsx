...
import { ADD_PAYMENT_METHOD_CODES } from 'type/orders';
...
const ClaimDetailPriceInfo = ({ claimInfo, title }: Props) => {
  return (
    <>
      <S.SectionContainer>
      ...
      <S.SectionContainer>
        ...
        <S.RowViewBetween>
          <T.Body2_Normal>라운드페이 포인트 사용</T.Body2_Normal>
      ...
      <S.SectionContainer>
        ...
        <S.RowViewBetween>
          <T.Body2_Normal>라운드페이 포인트 환불</T.Body2_Normal>
...
export default ClaimDetailPriceInfo;
