import { OrderCheckResponse } from 'type/api/order';
import * as S from '../OrderDetail.style';
import { GOODS_CUSTOM_MADE_TYPE, ItemStateKey } from 'type/claims';
    ...
    <>
      <S.ItemBoxAllWrap>
        <S.ItemBox key={item.goodsId}>
          <S.PayState $code={item.itemStatusEnum.code}>{item.itemStatusEnum.codeName}</S.PayState>
          <S.ItemDetail>
            <S.DisplayImg
