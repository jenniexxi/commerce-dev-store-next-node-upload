...
import { RefundBankInfo } from 'type/api/order';
import { Code } from 'apis/apiCommonType';
import { BankCode } from 'type/customer';
import { Separator, T } from '@ui/commons';
import { Button, Checkbox, Input, Selector } from '@ui/components';
import { colors } from '@ui/styles/theme';
import { useCheckAccount } from 'hooks/mutate/systemMutation';
...
const RefundInfo = ({ bank, bankListEnum }: Props) => {
  ...
  const { mutate: checkAccount } = useCheckAccount((resp) => {
    if (resp.success) {
