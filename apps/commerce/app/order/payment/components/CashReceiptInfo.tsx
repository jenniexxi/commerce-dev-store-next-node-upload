...
import { CashReceipt } from 'type/api/order';
import Radio, { RadioItem } from '@ui/components/radio/Radio';
import { CASH_RECEIPT_TYPE, IDENTITY_TYPE } from 'type/orders';
import { useOrderStore } from 'stores/orderStore';
import { Separator, T } from '@ui/commons';
import { Checkbox, Input, Selector } from '@ui/components';
...
const CashReceiptInfo = ({ cashReceipt }: Props) => {
  ...
  useEffect(() => {
    if (saveReceiptInfo !== payment.bankUseAgainYn) {
