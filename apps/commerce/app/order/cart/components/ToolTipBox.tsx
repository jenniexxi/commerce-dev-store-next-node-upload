'use client';
import NonModalTooltip, { TooltipItem } from '@ui/components/tooltip/NonModalTooltip';
import { showPriceText } from '@ui/utils';
import { ShippingInfo } from 'type/api/shoppingCart';
import { ADD_SHIPPING_PRICE_AREA_CODES, SHIPPING_POLICY_TYPE } from 'type/goods';
