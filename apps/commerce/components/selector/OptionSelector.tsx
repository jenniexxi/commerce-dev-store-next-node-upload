...
import * as S from '@ui/components/selector/Selector.style';
import { MiniCartsList } from 'type/api/shoppingCart';
import { GoodsOptions, GoodsOptionsList } from 'type/api/goods';
