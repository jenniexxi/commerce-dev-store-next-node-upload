import { constantsType } from '@ui/type/common';
import { MAIN_DISPLAY_TYPE } from 'type/display';
/** 팝업 노출 타입 */
...
export const GNB_DISPLAY_TYPE = {
  HOME: 'DISPLAY_GNB.GNB_TYPE.HOME', // 홈
  RANKING: 'DISPLAY_GNB.GNB_TYPE.RANKING', // 랭킹
  DEAL: 'DISPLAY_GNB.GNB_TYPE.DEAL', // 딜
  SUB_MAIN_A: 'DISPLAY_GNB.GNB_TYPE.SUB_MAIN_A', // 서브 메인A
  SUB_MAIN_B: 'DISPLAY_GNB.GNB_TYPE.SUB_MAIN_B', // 서브 메인B
  EXHIBITION_LIST: 'DISPLAY_GNB.GNB_TYPE.EXHIBITION_LIST', // 기획전 목록
  EXHIBITION_DETAIL: 'DISPLAY_GNB.GNB_TYPE.EXHIBITION_DETAIL', // 기획전 상세
} as const;

export type GnbDisplayType = constantsType<typeof GNB_DISPLAY_TYPE>;

export const SUB_TITLE_DISPLAY_TYPE = {
  NONE: 'DISPLAY_GNB.SUB_TITLE.NONE', // 비노출
  NEW: 'DISPLAY_GNB.SUB_TITLE.NEW', // 신규
  AD: 'DISPLAY_GNB.SUB_TITLE.AD', // 광고
  TEXT: 'DISPLAY_GNB.SUB_TITLE.TEXT', // 텍스트
} as const;

export type SubTitleDisplayType = constantsType<typeof SUB_TITLE_DISPLAY_TYPE>;
