...
export type DeviceTypeCodeKey = keyof typeof DEVICE_TYPE_CODES;
...
export const MAIN_DISPLAY_TYPE = {
  ...
  BANNER: 'DISPLAY_MAIN.CUSTOM_DETAIL_TYPE.BANNER', // 배너형
  CLICK_A: 'DISPLAY_MAIN.CUSTOM_DETAIL_TYPE.CLICK_A', // 클릭A 타입
...
export type mainDisplayType = constantsType<typeof MAIN_DISPLAY_TYPE>;
