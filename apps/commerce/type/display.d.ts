export type constantsType<T> = T[keyof T]; // TODO: 공통으로 빼기
...
export type GoodsAutoTypeCode = constantsType<typeof DISPLAY_BEST_GOODS_TYPE>;

const PAGE_INFO_ERROR_CODES = {
  NOT_DISPLAY: 'DISPLAY.GET_BEST.NOT_DISPLAY', //BEST 비활성화
} as const;

export type PageInfoErrorCode = constantsType<typeof PAGE_INFO_ERROR_CODES>;
...
/** 상품 정렬기준 코드 */
export type DisplayGoodsSortTypeCode = constantsType<typeof DISPLAY_GOODS_SORT_TYPE>;

/**
 * 노출 상품 판매상태
 */
export const GOODS_DISPLAY_SALES_STATUS = {
  /** 판매대기 */
 ...
 * 노출 상품 판매상태 코드 값
 */
export type GoodsDisplaySalesStatusKey = constantsType<typeof GOODS_DISPLAY_SALES_STATUS>;
...
export type DeviceTypeCode = constantsType<typeof DEVICE_TYPE_CODES>;
...
/** 상품 노출 기준 코드 */
export type GoodsDisplayTypeCode = constantsType<typeof GOODS_DISPLAY_TYPE>;
...
/** 상품 그룹 기준 코드 */
export type GoodsGroupTypeCode = constantsType<typeof GOODS_GROUP_TYPE>;
...
export type MainDisplayType = constantsType<typeof MAIN_DISPLAY_TYME>;
